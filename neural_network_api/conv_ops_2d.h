...
constexpr auto CONV_BLOCK_SIZE_M = 32;
constexpr auto CONV_BLOCK_SIZE_K = 4;
constexpr auto CONV_THREAD_BLOCK_N = 4;
constexpr auto CONV_THREAD_BLOCK_M = 4;
...
void filter_convolve_2d(float * d_input, float * d_filter, float * d_output, shape input_shape, shape output_shape, shape filter_shape, size_t batch_size);
...
void filter_outer_convolve_2d(float * d_input, float * d_filter, float * d_output, shape input_shape, shape output_shape, shape filter_shape, size_t batch_size);
void filter_convolve_2d_derivative(float * d_input, float * d_pds, float * d_output, shape input_shape, shape pd_shape, shape output_shape, size_t batch_size);
